...
class GPUModelRunner(
    ...
    def _update_states(self, scheduler_output: "SchedulerOutput") -> None:
        ...
        try:
            return self._update_states_inner(scheduler_output)
        finally:
    ...
    def _prepare_inputs(
        ...
        kperf_begin("prepare_inputs")
        try:
            return self._prepare_inputs_inner(
                scheduler_output,
                num_scheduled_tokens,
                max_num_scheduled_tokens,
            )
        finally:
            kperf_finish("prepare_inputs")
    ...
    def _sample(
        ...
        kperf_begin("sample")
        try:
            return self._sample_inner(logits, spec_decode_metadata)
        finally:
            kperf_finish("sample")
    ...
    def _bookkeeping_sync(
        ...
        try:
            return self._bookkeeping_sync_inner(
                scheduler_output,
                sampler_output,
                logits,
                hidden_states,
    ...
    def _model_forward(
        ...
        **model_kwargs: dict[str, Any],
        ...
        kperf_begin("forward")
        try:
            return self._model_forward_inner(
                input_ids=input_ids,
                positions=positions,
